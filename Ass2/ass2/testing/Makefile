...
BINS=create insert select stats gendata dump x1 x2_3 x2_4 x3_3 x3_4

all : clear $(LIBS) $(BINS) clean
...
x2_3 : x2_3.o reln.o page.o tuple.o tsig.o bits.o hash.o query.o
	$(CC) -o x2_3 x2_3.o $(LIBS)

x2_4 : x2_4.o reln.o page.o tuple.o tsig.o bits.o hash.o query.o
	$(CC) -o x2_4 x2_4.o $(LIBS)

x3_3 : x3_3.o reln.o page.o tuple.o tsig.o bits.o hash.o
	$(CC) -o x3_3 x3_3.o $(LIBS)

x3_4 : x3_4.o reln.o page.o tuple.o tsig.o bits.o hash.o
	$(CC) -o x3_4 x3_4.o $(LIBS)
